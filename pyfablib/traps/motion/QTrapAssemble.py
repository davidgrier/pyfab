...
class TrapAssemble(TrapMove):
        ...
        if targets is not None:
            ...
            while not (done and close):
                ...
                for trap in trajectories.keys():
                    ...
                    def f(x): return np.random.random_sample() * \
    ...
    def _pair_search(self, v, t, trap_limit=8):
        ...
        if N < trap_limit:
            ...
            def f(x): return np.random.permutation(v)
