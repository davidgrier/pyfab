...
class Ui_PyFab(object):
    def setupUi(self, PyFab):
        ...
        self.bpausequeue.setGeometry(QtCore.QRect(20, 390, 89, 25))
        self.bpausequeue.setObjectName("bpausequeue")
        self.bclearqueue = QtWidgets.QPushButton(self.tabTasks)
        self.bclearqueue.setGeometry(QtCore.QRect(130, 390, 89, 25))
        self.bclearqueue.setObjectName("bclearqueue")
        self.TaskManagerView = QtWidgets.QListView(self.tabTasks)
        self.TaskManagerView.setGeometry(QtCore.QRect(10, 10, 231, 341))
        self.TaskManagerView.setObjectName("TaskManagerView")
        self.scrollArea_2 = QtWidgets.QScrollArea(self.tabTasks)
        self.scrollArea_2.setGeometry(QtCore.QRect(280, 10, 211, 341))
        self.scrollArea_2.setWidgetResizable(True)
        self.scrollArea_2.setObjectName("scrollArea_2")
        self.TaskPropertiesView = QtWidgets.QWidget()
        self.TaskPropertiesView.setGeometry(QtCore.QRect(0, 0, 209, 339))
