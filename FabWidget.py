...
class Ui_PyFab(object):
    def setupUi(self, PyFab):
        ...
        self.gridLayout_2.addWidget(self.experimentPath, 1, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bserialize, 1, 1, 1, 1)
        self.bdeserialize = QtWidgets.QPushButton(self.tabTasks)
        self.bdeserialize.setObjectName("bdeserialize")
        self.gridLayout_2.addWidget(self.bdeserialize, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.loop, 2, 2, 1, 1)
