...
class Ui_PyFab(object):
    def setupUi(self, PyFab):
        ...
        self.tabVisionLayout = QtWidgets.QVBoxLayout(self.tabVision)
        self.tabVisionLayout.setObjectName("tabVisionLayout")
        self.visionScrollArea = QtWidgets.QScrollArea(self.tabVision)
        self.visionScrollArea.setWidgetResizable(True)
        self.visionScrollArea.setObjectName("visionScrollArea")
        self.vision = QtWidgets.QWidget()
        self.vision.setGeometry(QtCore.QRect(0, 0, 619, 602))
        self.vision.setObjectName("vision")
        self.visionLayout = QtWidgets.QVBoxLayout(self.vision)
        self.visionLayout.setContentsMargins(0, 0, 0, 0)
        self.visionLayout.setSpacing(0)
        self.visionLayout.setObjectName("visionLayout")
        self.visionScrollArea.setWidget(self.vision)
        self.tabVisionLayout.addWidget(self.visionScrollArea)
        ...
        self.TaskPropertiesView.setGeometry(QtCore.QRect(0, 0, 407, 537))
