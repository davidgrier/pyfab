...
class Ui_PyFab(object):
    def setupUi(self, PyFab):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(20, 20, 611, 371))
        ...
        self.taskScrollArea = QtWidgets.QScrollArea(self.horizontalLayoutWidget)
        ...
        self.TaskPropertiesView.setGeometry(QtCore.QRect(0, 0, 400, 367))
