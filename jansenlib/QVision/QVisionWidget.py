...
class Ui_QVisionWidget(object):
    def setupUi(self, QVisionWidget):
        ...
        self.gridLayout.addWidget(self.linkTol, 3, 1, 1, 1)
        ...
        self.threshold = QtWidgets.QDoubleSpinBox(self.groupProcess)
        self.threshold.setDecimals(1)
        self.threshold.setMinimum(20.0)
        self.threshold.setMaximum(100.0)
        self.threshold.setProperty("value", 50.0)
    ...
    def retranslateUi(self, QVisionWidget):
        ...
        self.threshold.setStatusTip(_translate("QVisionWidget", "Confidence threshold for detections. Throw away features detected below this confidence."))
        self.threshold.setSuffix(_translate("QVisionWidget", " %"))
