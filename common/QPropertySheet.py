...
from PyQt5.QtWidgets import (QFrame, QLabel, QLineEdit, QCheckBox,
                             QGridLayout)
...
class QNumericProperty(QLineEdit):
...
class QBooleanProperty(QCheckBox):

    valueChanged = pyqtSignal(str, bool)
