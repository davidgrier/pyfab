...
class Ui_QVisionWidget(object):
    def setupUi(self, QVisionWidget):
        ...
        self.plotZ = PlotWidget(QVisionWidget)
        ...
        self.verticalLayout.addWidget(self.plotZ)
        self.plotAN = PlotWidget(QVisionWidget)
        self.plotAN.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(2)
        sizePolicy.setHeightForWidth(self.plotAN.sizePolicy().hasHeightForWidth())
        self.plotAN.setSizePolicy(sizePolicy)
        self.plotAN.setStatusTip("")
        self.plotAN.setObjectName("plotAN")
        self.verticalLayout.addWidget(self.plotAN)
