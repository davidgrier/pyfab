...
class Ui_doVisionWidget(object):
    def setupUi(self, doVisionWidget):
        ...
        self.gridLayout.addWidget(self.rtenabled, 9, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.groupDetect, 10, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.groupFilter, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.SRC_paused, 4, 0, 1, 1)
        self.bsave = QtWidgets.QPushButton(doVisionWidget)
        self.bsave.setObjectName("bsave")
        self.gridLayout.addWidget(self.bsave, 2, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.ppenabled, 9, 1, 1, 1)
        self.bstop = QtWidgets.QPushButton(doVisionWidget)
        self.bstop.setEnabled(False)
        self.bstop.setObjectName("bstop")
        self.gridLayout.addWidget(self.bstop, 8, 1, 1, 1)
        self.bstart = QtWidgets.QPushButton(doVisionWidget)
        self.bstart.setObjectName("bstart")
        self.gridLayout.addWidget(self.bstart, 8, 0, 1, 1)
        self._paused = QtWidgets.QCheckBox(doVisionWidget)
        self._paused.setObjectName("_paused")
        self.gridLayout.addWidget(self._paused, 4, 1, 1, 1)
        self.frameViewArea = QtWidgets.QScrollArea(doVisionWidget)
        self.frameViewArea.setMinimumSize(QtCore.QSize(0, 150))
        self.frameViewArea.setWidgetResizable(True)
        self.frameViewArea.setObjectName("frameViewArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 321, 197))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.scrollAreaWidgetContents)
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.FramesView = QtWidgets.QListView(self.scrollAreaWidgetContents)
        self.FramesView.setObjectName("FramesView")
        self.horizontalLayout.addWidget(self.FramesView)
        self.SelectedFramesView = QtWidgets.QTableView(self.scrollAreaWidgetContents)
        self.SelectedFramesView.setObjectName("SelectedFramesView")
        self.horizontalLayout.addWidget(self.SelectedFramesView)
        self.frameViewArea.setWidget(self.scrollAreaWidgetContents)
        self.gridLayout.addWidget(self.frameViewArea, 3, 0, 1, 2)
